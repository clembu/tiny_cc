...
module Patch : sig
  ...
  val apply : 'k char_build -> 'k t -> 'k char_build
...
val available_cp : 'k Kind.t -> 'k char_build -> int

val flaw_build_state : 'k char_build -> 'k Flaw.t -> build_state

val power_build_state : 'k Kind.t -> 'k char_build -> 'k Power.t -> build_state
